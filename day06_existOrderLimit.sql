...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
 select urun_isim ,musteri_isim from nisan as n where exists (select urun_isim from mart as m where n.urun_isim=m.urun_isim);
 
 /* -----------------------------------------------------------------------------
  ORNEK3: Her iki ayda birden ortak satılmaya ürünlerin URUN_ISIM'lerini ve bu ürünleri
  NİSAN ayında satın alan MUSTERI_ISIM'lerini listeleyen bir sorgu yazınız. 
 -----------------------------------------------------------------------------*/
 select urun_isim ,musteri_isim from nisan as n where not exists (select urun_isim from mart as m where n.urun_isim=m.urun_isim);
...
==============================================================================*/
    ...
    -- örnek1 : isim i null olanları sorgula
    select * from insanlar where isim is null;
    -- ORNEK2 isim i null olmayanlar
...
-----------------------------------------------------------------------------*/
update insanlar set isim=coalesce(isim,'Henuz girilmedi'),
...
/*================================ LİMİT  ===================================
  1-Listeden ilk 10 veriyi getir
==============================================================================*/  
-- 1-Listeden ilk 10 veriyi getir
select * from kisiler limit 10;
-- 2- Listeden 10. veriden sonraki 2 veriyi al(11-12)
select * from kisiler limit 10,2; -- ilk sayı hariç 11 den başlar 2. sayı kadar alır
/* ----------------------------------------------------------------------------
